...
export declare const sassUrlVariants: (url: string, extensions: string[]) => string[];
export declare const resolveGlobUrl: (url: string, includePaths?: string[] | undefined) => string[];
